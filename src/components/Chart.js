  ...
  return (
    <>
      ...
      <section className="steps  pb-60 mt-50">
        <div className="container text-center mt-3 mt-md-5">
          ...
          <div className="row text-center">
            ...
            <div className="col-md-4 col-10 mx-auto card-box text-center custom-card-box">
          ...
          <div className="col-md-12 col-10 mx-auto mt-50 text-center">
            <a className="btn-blue mt-50" href="#">
              See How It’s Work
            </a>
          </div>
        </div>
